    ...
    <section id="newsletter">
      ...
      <div class="searchbox">
        <input
          ...
          class="v-step-4"
        />
        <button @click="locatorButtonPressed" value="search">
          <i class="fas fa-crosshairs marker"></i>
        </button>
      </div>
    </section>
...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyCyjLzYALQYPTtKH1F10UNH9XJI80JZXhk"></script>
<script>
    ...
    async getAddressFrom(lat, long) {
      const response = await axios.get(
        "https://maps.googleapis.com/maps/api/geocode/json?latlng=" +
          ...
          "," +
          long +
          "&key=AIzaSyCyjLzYALQYPTtKH1F10UNH9XJI80JZXhk"
      );
...
.searchbox {
  ...
  border-radius: 6px;
  box-shadow: 0 2px 4px 0 #2679e6ce, 0 10px 15px 0 rgba(126, 126, 126, 0.12),
...
input[type="search"] {
  ...
  box-shadow: 0 -2px 2px 0 rgba(199, 199, 199, 0.55), 0 1px 1px 0 #fff,
    0 2px 2px 1px #3380e47e, 0 2px 4px 0 #b2b2b2 inset,
